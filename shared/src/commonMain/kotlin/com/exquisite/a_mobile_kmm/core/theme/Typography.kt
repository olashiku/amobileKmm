...
@Composable fun getPoppinsMedium11() = poppinsTextStyle(FontWeight.Medium, 11, 14)
...
@Composable fun getPoppinsBold13() = poppinsTextStyle(FontWeight.Bold, 13, 16)
...
@Composable fun getPoppinsBold22() = poppinsTextStyle(FontWeight.Bold, 22, 28)
