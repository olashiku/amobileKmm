package com.exquisite.a_mobile_kmm.feature.cleaning_service.presenter.basic_cleaning_price
...
@Composable
fun BasicCleaningPriceDetailsScreen(
            ...
            Column(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Recurring cleaning service",style = getPoppinsSemiBold18(),color =Color(0XFF1A1A1A))
                    }
                    Column(modifier.padding(start = 20.dp, end = 20.dp, top = 20.dp)) {
                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally,modifier= modifier.fillMaxWidth()){
                            ...
                            Text(text = "₦${basicCleaningBreakdownModel.fee.formatBalance()}",
