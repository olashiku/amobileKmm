package com.exquisite.a_mobile_kmm.feature.septic.presenter.septic_service
...
import com.exquisite.a_mobile_kmm.feature.septic.domain.model.septicOptions

@Composable
fun SepticServiceScreen(goBack: () -> Unit, goToNextPage: (String) -> Unit,
    ...
    Box(
        ...
        Column {
            ...
            Column(modifier = Modifier.padding(start = 20.dp, end = 20.dp)) {
                ...
                Text(
                    text = "Kindly select your septic  service option",
                    style = getPoppinsRegular14(), color = Color(0xFF252525)
                )
                Spacer(modifier = Modifier.height(16.dp))
                RadioOptionGroup(
                    options = septicOptions,
