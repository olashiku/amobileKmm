package com.exquisite.a_mobile_kmm.feature.mobile_toilet.presenter.mobile_toilet
...
import com.exquisite.a_mobile_kmm.feature.mobile_toilet.domain.model.mobileToiletOption

@Composable
fun  MobileToiletService(goBack: () -> Unit,
                         goToNextPage:(String)->Unit,
                         modifier: Modifier = Modifier) {

    var selectedCleaningOption by remember { mutableStateOf("event") }
    ...
    Box(
        ...
        Column {
            ...
            Column(modifier = Modifier.padding(start = 20.dp, end = 20.dp)) {
                ...
                Text(
                    text = "Kindly select your mobile toilet option",
                    style = getPoppinsRegular14(), color = Color(0xFF252525)
                )
                Spacer(modifier = Modifier.height(16.dp))
                RadioOptionGroup(
                    options = mobileToiletOption,
